/*!
 Stencil Node System v3.2.1 | MIT Licensed | https://stenciljs.com
 */
...
lockfile = createCommonjsModule((function(e) {
 e.exports = function(e) {
  ...
  l = i.GLOBSTAR = s.GLOBSTAR = {}, c = r(175), u = {
   ...
   var n, i, s, o, a, c, d, g, y, v, E, b, _, w, S, O, k, A, C, T, L, $, x, R, N, I, P, j, D, F, M, G;
  ...
  e.exports = function(e, t, r, g, y, v, E) {
   ...
   n || "function" == typeof x[f] || o(x, f, m)), w && k && k.name !== d && (S = !0, 
   A = function e() {
    return k.call(this);
   }), n && !E || !h && !S && O[f] || o(O, f, A), a[t] = A, a[_] = m, y) if (L = {
    values: w ? A : b(d),
    keys: v ? A : b(p),
    entries: C
   }, E) for ($ in L) $ in O || s(O, $, L[$]); else i(i.P + i.F * (h || S), t, L);
   return L;
  };
 }, function(e, t) {
  e.exports = function(e) {
  ...
  var n, i, s, o, a = r(69), l = r(11), c = r(48), u = r(100), f = r(41), h = r(34), p = r(46), d = r(181), m = r(183), g = r(108), y = r(109).set, v = r(191)(), E = r(70), b = r(104), _ = r(202), w = r(105), S = "Promise", O = l.TypeError, k = l.process, A = k && k.versions, C = A && A.v8 || "", T = l[S], L = "process" == u(k), $ = function() {}, x = i = E.f, R = !!function() {
   var e, t;
   try {
